<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    <li class="nav-item nav-profile">
      <a href="#" class="nav-link">
        ...
        <div class="nav-profile-text d-flex flex-column">
          <span class="font-weight-bold mb-2">ApniTeam11</span>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo $base_url ?>pages/blog/">
        <span class="menu-title">Blog</span>
        <i class="mdi mdi-format-list-bulleted menu-icon"></i>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="<?php echo $base_url ?>pages/newsletter">
        <span class="menu-title">News Letter</span>
        <i class="mdi mdi-contacts menu-icon"></i>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="<?php echo $base_url ?>pages/contact_us">
