            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Blog Content </h3>
                        <a href="./addblog.php">
                            <button type="button" class="btn btn-gradient-primary btn-fw">+ Add Blog</button>
                        </a>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($conn, "SELECT * FROM `blog` WHERE `deleted_at` is null");
                                        if ($query->num_rows > 0) {
                                            $i = 1;
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-wrap"><?php echo substr($data['title'], 0, 10) . "..."; ?></p>
                                                    </td>
                                                    <td>
                                                        <p class="text-wrap"><i>Content...</i></p>
                                                    </td>
                                                    <td>
                                                        <p class="text-wrap"><?php echo $data['author_name']; ?></p>
                                                    </td>
                                                    <td>
                                                        <p class="text-wrap"><?php echo $data['update_at']; ?></p>
                                                    </td>
                                                    <td>
                                                        <a href="./editblog.php?id=<?php echo $data['id']; ?>">
                                                            <button type="button" class="btn btn-gradient-warning btn-sm"><i class="mdi mdi-pencil"></i></button>
                                                        </a>
                                                        <a href="./deleteblog.php?id=<?php echo $data['id']; ?>">
                                                            <button type="button" class="btn btn-gradient-danger btn-sm"><i class="mdi mdi-delete"></i></button>
                                                        </a>
                                                    </td>
                                                </tr>
